...
# The Enemy AI
def enemyAI(enemyHealth, playerHealth, enemyEnergy, playerEnergy, enemyAttackDamage, playerAttackDamage, isPlayerDefended, isEnemyDefended, experience, enemyMaxHealth):
    enemyHealthPercent = math.ceil((enemyHealth/enemyMaxHealth)*100)
